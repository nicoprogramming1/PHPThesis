...
require_once 'funciones/insertar_proveedor.php';
...
if (!empty($_POST['BotonRegistrar'])) {
    ...
    $Mensaje = Validar_Datos_Registrar_Proveedor();
    if (empty($Mensaje)) {
        ...
        $resultado = InsertarProveedor($MiConexion, $nombreProveedor, $cuil, $email, $telefono, $ciudad, $domicilio);
        if ($resultado) {
            $Mensaje = "Proveedor registrado con éxito.";
            $Estilo = "success";
        } else {
            $Mensaje = "Error al registrar el proveedor en la base de datos.";
            $Estilo = "danger";
        }
    }
}
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Registrar Proveedor</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control" id="nombreProveedor" placeholder="Ingresa el nombre del proveedor" name="nombreProveedor">
                                    </div>

                                    <div class="mb-3">
                                      <label for="cuil" class="form-label">CUIL (*)</label>
                                      <input type="text" class="form-control" id="cuil" placeholder="Ingresa el CUIL" name="cuil">
                                    </div>
