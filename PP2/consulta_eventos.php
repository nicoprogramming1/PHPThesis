						                ...
						                if ($selectedEvento === "todos") {
						                    if (!empty($ListadoEventos)) {
						                        ...
						                        foreach ($ListadoEventos as $evento) {
						                            ...
						                            echo '<td>' . countAsistentesEvento($MiConexion, $evento['IDEVENTO']) . '</td>';
						                            echo '</tr>';
						                            $contador++;
						                        }
						                    } else {
						                        echo '<tr>';
						                        echo '<td colspan="5">No hay eventos disponibles.</td>';
						                        echo '</tr>';
						                    }
						                    ...
						                    if ($contenidoEvento) {
				                                ...
				                                // Formatear la fechaEvento a dd/mm/aaaa antes de imprimir en la tabla
											        ...
											        echo '<td>' . $fechaEventoFormateada . '</td>';
				                                echo '<td>' . countAsistentesEvento($MiConexion, $contenidoEvento['IDEVENTO']) . '</td>';
				                                echo '</tr>';
						                    } else {
						                        echo '<tr>';
