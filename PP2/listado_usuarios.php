...
if (!empty($_POST['BotonModificar'])) {
    ...
    $Mensaje=Validar_Seleccion_Modificar_Usuarios();
    if (empty($Mensaje)) {
        // Obtener los IDs de los usuarios seleccionados
        $usuariosSeleccionados = $_POST['seleccionar'];

        // Redirigir a la página de modificación con los IDs seleccionados como parámetros
        header('Location: modificar_usuario.php?id=' . implode(',', $usuariosSeleccionados));
        exit;
    }
}
                        	...
                        	<form role="form" method="post">
	                        	<div class="row">
		                            <table class="table">
		                                <thead>
		                                    <tr>
		                                        <?php require_once 'vercolumnas.inc.php'; ?>
		                                    </tr>
		                                </thead>
		                                <tbody>
		                                	    <?php require_once 'listado.usuarios.inc.php'; ?>                                 
		                                </tbody>
		                            </table>
		                            <div class="col-md-12">
