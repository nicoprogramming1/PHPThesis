...
function Listar_Recepciones($vConexion) {
    ...
    $SQL = "SELECT rc.idRecepcionCompra, rc.idCompra, rc.fechaRecepcionCompra, e.estadoRecepcion, re.nroRemito
            ...
            WHERE rc.idEstadoRecepcionCompra = e.idEstadoRecepcion AND rc.idRecepcionCompra = d.idRecepcionCompra AND d.idRemito = re.idRemito AND rc.idEstadoRecepcionCompra = 1 ORDER BY rc.fechaRecepcionCompra";
