...
if (!empty($_POST['BotonModificar'])) {
    ...
    $Mensaje=Validar_Seleccion_Modificar_Proveedor();
    if (empty($Mensaje)) {
        // Obtener los IDs del proveedor seleccionado
        $proveedorSeleccionado = $_POST['seleccionar'];

        // Redirigir a la página de modificación con los IDs seleccionados como parámetros
        header('Location: modificar_proveedor.php?id=' . implode(',', $proveedorSeleccionado));
        exit;
    }
}
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Listado de Proveedores</a></li>
                        </ul>
                    	...
                    	<form role="form" method="post">
						    <div class="row">
						        <table class="table">
						            <thead>
						                <tr>
						                    <?php require_once 'vercolumnas.proveedores.inc.php'; ?>
						                </tr>
						            </thead>
						            <tbody>
						                <?php require_once 'listado.proveedores.inc.php'; ?>                                
						            </tbody>
						        </table>
						        <div class="col-md-12">
