...
if (!empty($_POST['BotonModificar'])) {
    ...
    $Mensaje=Validar_Seleccion_Modificar_Facturas();
    if (empty($Mensaje)) {
        // Obtener los IDs de la factura seleccionada
        $facturaSeleccionada = $_POST['seleccionar'];

        // Redirigir a la página de modificación con los IDs seleccionados como parámetros
        header('Location: modificar_factura.php?id=' . implode(',', $facturaSeleccionada));
        exit;
    }
}
                    	...
                    	<form role="form" method="post">
						    <div class="row">
						        <table class="table">
						            ...
						            <tbody>
						                <?php require_once 'listado.facturas.inc.php'; ?>                                
						            </tbody>
						        </table>
						        <div class="col-md-12">
