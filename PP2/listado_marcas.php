...
if (!empty($_POST['BotonModificar'])) {
    ...
    $Mensaje=Validar_Seleccion_Modificar_Marca();
    if (empty($Mensaje)) {
        // Obtener los IDs de la marca seleccionado
        $marcaSeleccionada = $_POST['seleccionar'];

        // Redirigir a la página de modificación con los IDs seleccionados como parámetros
        header('Location: modificar_marca.php?id=' . implode(',', $marcaSeleccionada));
        exit;
    }
}
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Listado de marcas</a></li>
                        </ul>
                    	...
                    	<form role="form" method="post">
						    <div class="row">
						        <table class="table">
						            <thead>
						                <tr>
						                    <?php require_once 'vercolumnas.marcas.inc.php'; ?>
						                </tr>
						            </thead>
						            <tbody>
						                <?php require_once 'listado.marcas.inc.php'; ?>                                
						            </tbody>
						        </table>
						        <div class="col-md-12">
