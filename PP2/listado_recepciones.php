...
if (!empty($_POST['BotonModificar'])) {
    ...
    $Mensaje=Validar_Seleccion_Modificar_Recepciones();
    if (empty($Mensaje)) {
        // Obtener los IDs de la recepcion seleccionada
        $recepcionSeleccionada = $_POST['seleccionar'];

        // Redirigir a la página de modificación con los IDs seleccionados como parámetros
        header('Location: modificar_recepcion.php?id=' . implode(',', $recepcionSeleccionada));
        exit;
    }
}
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Listado de recepciones</a></li>
                        </ul>
                    	...
                    	<form role="form" method="post">
						    <div class="row">
						        <table class="table">
						            <thead>
						                <tr>
						                    <?php require_once 'vercolumnas.recepciones.inc.php'; ?>
						                </tr>
						            </thead>
						            <tbody>
						                <?php require_once 'listado.recepciones.inc.php'; ?>                                
						            </tbody>
						        </table>
						        <div class="col-md-12">
