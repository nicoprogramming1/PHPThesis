...
require_once 'funciones/insertar_facturas.php';

$Mensaje='';
$Estilo='warning';
if (!empty($_POST['BotonRegistrar'])) {
    // Estoy en condiciones de poder validar los datos
    $Mensaje = Validar_Datos_Registrar_Factura();
    if (empty($Mensaje)) {
        // Insertar en la base de datos
        $resultado = InsertarFacturaEnBaseDeDatos($MiConexion);
        if ($resultado) {
            $Mensaje = "Factura registrada con éxito.";
            $Estilo = "success";
        } else {
            $Mensaje = "Error al registrar la factura en la base de datos.";
            $Estilo = "danger";
        }
    }
}
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Registrar Factura</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control" id="nroFactura" placeholder="Ingresa el número de la factura a registrar" name="nroFactura">
                                    </div>

                                    <div class="mb-3">
                                      <label for="importeFactura" class="form-label">Importe total (*)</label>
                                      <input type="text" class="form-control" id="importeFactura" placeholder="Ingresa el importe" name="importeFactura">
                                    </div>

                                    <div class="mb-3">
                                        <label for="detalleFactura" class="form-label">Detalle factura</label>
                                        <textarea class="form-control" id="detalleFactura" name="detalleFactura" rows="4"></textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="fechaFactura" name="fechaFactura" placeholder="Selecciona la fecha de la factura">
                                    </div>
