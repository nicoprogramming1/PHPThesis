...
if (!empty($_POST['BotonRegistrar'])) {
    ...
    $Mensaje = Validar_Datos_Registrar_Usuarios();
    if (empty($Mensaje)) {
        // Crear un array asociativo con los datos del nuevo usuario
        $nuevoUsuario = array(
            'email' => $_POST['email'],
            'clave' => $_POST['clave'],
            'nombre' => $_POST['nombre'],
        ...
        if (InsertarUsuarios($MiConexion, $nuevoUsuario)) {
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Registrar usuario</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Email</label>
                                         <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="nombre@ejemplo.com" name="email">
                                    </div>
                                    <div class="mb-3">
                                      <label for="exampleFormControlInput1" class="form-label">Clave</label>
                                      <input type="password" class="form-control" id="exampleFormControlInput1" placeholder="Contraseña" name="clave">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">Indique el Rol (*)</label>
