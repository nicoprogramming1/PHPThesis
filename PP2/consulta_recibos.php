...
if (!empty($_POST['BotonVerDetalles'])) {
    ...
    $Mensaje=Validar_Seleccion_Modificar_Recibos();
    if (empty($Mensaje)) {
        // Obtener los IDs del recibo seleccionado
        $reciboSeleccionado = $_POST['seleccionar'];

        // Redirigir a la página de modificación con los IDs seleccionados como parámetros
        header('Location: recibo_seleccionado.php?id=' . implode(',', $reciboSeleccionado));
        exit;
    }
}
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Consultas de recibos</a></li>
                        </ul>
                        ...
                        <form role="form" method="post">
						    <div class="row">
						        <table class="table">
						            <thead>
						                <tr>
						                    <?php require_once 'vercolumnas.recibos.inc.php'; ?>
						                </tr>
						            </thead>
						            <tbody>
						                <?php require_once 'listado.recibos.inc.php'; ?>                                
						            </tbody>
						        </table>
						        <div class="col-md-12">
